...
grayscale:
	$(NVCC) $(CUDA_FLAGS) src/grayscale.cu src/VideoLoader.cpp -o $(TITLE)_grayscale.out $(FFMPEG_LIBS)
...
ascii:
	...
	ffmpeg -i tmp.mp4 -i $(INPUT) -c copy -map 0:v:0 -map 1:a:0 $(TITLE)_ascii.mp4
